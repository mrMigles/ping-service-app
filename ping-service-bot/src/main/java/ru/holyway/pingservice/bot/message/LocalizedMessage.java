...
public enum LocalizedMessage {
  ...
  HI("Привет!\n"
      + "Я предоставляю упрощенный функицонал сервиса <a href=\"https://ping-services.herokuapp.com\">Ping Service</a>\n"
      + "Я помогу твоему приложению быть всегда доступным и не дам усыпить его. \n"
      + "Я делаю это путем отправки периодических ping запросов на указанный тобой URL с указанной периодичностью.\n"
